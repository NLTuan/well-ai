...
Diagnostic_Analysis = Task(
    description=(
        "Given the patient's input: {input} and symptoms and medical data gotten from the Symptom Collection Specialist i.e the Nurse agent, this agent analyzes the information using advanced diagnostic algorithms."
